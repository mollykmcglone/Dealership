...
describe(Dealership) do
  ...
  describe('#cars') do
    it("is an array of cars for the dealership that is empty at first") do
      test_dealership = Dealership.new("Bob's Used Cars")
  ...
  describe('.all') do
    it("is an array of all the dealerships that is empty at first") do
      expect(Dealership.all()).to(eq([]))
    end
  end

  describe('.clear') do
    it("empties out all of the saved dealerships from the array") do
